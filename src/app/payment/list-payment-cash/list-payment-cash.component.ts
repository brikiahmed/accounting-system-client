...
@Component({
  selector: 'app-list-payment-cash',
  templateUrl: './list-payment-cash.component.html',
  styleUrls: ['./list-payment-cash.component.scss']
})
export class ListPaymentCashComponent implements OnInit {
  paymentUrl;
